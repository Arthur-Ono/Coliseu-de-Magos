...
public class GerenciadorCSV {
    ...
    public void salvar(List<Ranqueados> magos, String nomeArquivo) {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(nomeArquivo))) {
            ...
            writer.write("id,codinome,escola,vidaMax,manaMax,foco,poderBase,resistencia,controlador,horaEntrada,tipo,velocidade");
            writer.newLine();
    ...
    public List<Ranqueados> carregar(String nomeArquivo) {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(nomeArquivo))) {
            ...
            while ((linha = reader.readLine()) != null) {
                ...
                int velocidade = Integer.parseInt(dados[11]);
                
                Ranqueados mago = null;
                switch (tipo) {
                    case "MagoElemental":
                        mago = new MagoElemental(id, codinome, vidaMax, manaMax, foco, poderBase, resistencia, controlador, velocidade);
                        break;
                }
