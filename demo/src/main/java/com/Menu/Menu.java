...
public class Menu {
    ...
    // Define o nome padrão do arquivo CSV como uma constante para não errar a digitação.
    ...
    public void menuPrincipal(Gerenciador gerenciador) {
        ...
        // O loop principal do jogo. Enquanto 'running' for verdadeiro, o menu continua aparecendo.
        while (running) {
            ...
            // Após avançar o turno, verifica na agenda se há algum duelo marcado para o novo turno.
